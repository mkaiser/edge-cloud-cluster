...
#
# Generates:
#   longhorn/smtp-credentials-sealed.yaml  — longhorn-system/smtp-credentials
set -euo pipefail
...
[[ -z "$SKIP_GIT_COMMIT" ]] && ask_and_commit_sealed_files "Seal longhorn smtp-credentials" "${SEALED_FILES[@]}"
